...
Join our support group for reporting bugs!
...
But there is no need to donate for hitomi"""
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup([
                  [InlineKeyboardButton(text="Add hitomi to your group", url="t.me/{}?startgroup=true".format(context.bot.username))],
                  [InlineKeyboardButton(text="Support Group", url="https://t.me/hitomi_support"), InlineKeyboardButton(text="Help", callback_data="help_back")]]))
    else:
